      ...
      return (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-10">
            ...
            <Button className="bg-gradient-to-r from-pastel-pink to-orange-400 hover:from-pastel-pink/90 hover:to-orange-400/90 text-white" onClick={() => router.push("/dashboard/create")}>Create Your First Coloring Page</Button>
          </CardContent>
        </Card>
      )
    }
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          {isSelectionMode && selectedImages.length > 0 && (
            <Button onClick={handleCreateBook} className="text-white bg-gradient-to-r from-pastel-pink to-orange-400 hover:from-pastel-pink/90 hover:to-orange-400/90 text-white">
